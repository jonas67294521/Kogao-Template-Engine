...
class Build_Index extends Database{

    var $template = "page/build/index";
    ...
    public function onLoad(){
        ...
        if(basename(dirname($_SERVER["PHP_SELF"]))){
            echo file_get_contents("http://" . $_SERVER["SERVER_NAME"] . "/".basename(dirname($_SERVER["PHP_SELF"]))."/view/assets/js/build.php");
        }else {
            echo file_get_contents("http://" . $_SERVER["SERVER_NAME"] . "/view/assets/js/build.php");
        }
